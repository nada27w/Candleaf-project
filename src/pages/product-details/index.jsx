...
const Product = () => {
  ...
  const addItem = () => {
    ...
    if (itemsStorage) {
      ...
      if(foundItemIndex !== -1){//If the product is found (foundItemIndex !== -1), the quantity is updated by adding the new quantity to the existing one.3
        //add the input qty to the existing product
        prevCartItems[foundItemIndex].qty= +prevCartItems[foundItemIndex].qty + +qty
        ...
        const cartItemsValue = [//If the product is not found, a new array is created that includes the new product along with the existing ones 4
          ...prevCartItems,
          {
            productId,
            imageLink,
      ...
      const cartItemsValue = [//If no items are found in localStorage, a new array is created with the new product and stored in localStorage.6
        {
          productId,
          imageLink,
          productName,  
